...
await playConsumer.subscribe({ topic: 'PlayTopic', fromBeginning: true })
...
await pauseConsumer.subscribe({ topic: 'PauseTopic', fromBeginning: true })
...
await timeConsumer.subscribe({ topic: 'TimeTopic', fromBeginning: true })
...
await addedClientConsumer.subscribe({ topic: 'AddClientTopic', fromBeginning: true })
...
await deletedClientConsumer.subscribe({ topic: 'DeleteClientTopic', fromBeginning: true })
